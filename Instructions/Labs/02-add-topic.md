...
### Step 1 — Create the topic with Copilot
...
### Step 2 — Check the questions, and edit with natural language
...
### Step 3 — Configure entities: control what the agent accepts
...
### Step 4 — Use a variable to branch the flow
...
### Step 5 — Summarize with an Adaptive Card
...
### Step 6 — Make the details reusable
...
### Step 7 — Point the agent at the topic, then test both paths
...
### Stretch A — Make slot filling actually work
...
### Stretch B — Build a topic from blank and chain it
...
### Stretch C — Generate a ticket number with Power Fx
